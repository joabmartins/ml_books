# bibliotecas importadas necessárias
...
from airflow.providers.postgres.hooks.postgres import PostgresHook
  ...
  # Parâmetros necessários para executar a DAG
default_args = {
     'owner': 'airflow',
...
dag = DAG(
  ...
  # TAREFA 01 : HELLO WORLD
  # Função Python para ser executada
def iniciar_pipeline(ti):
       print("Hello, World!")

  # Definição do operador usado (executar python) e declaração da primeira tarefa
